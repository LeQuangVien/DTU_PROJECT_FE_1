                    ...
                    <div class="user-box">
                        <a class="d-flex align-items-center">
                            <router-link to="/dang-nhap">
                                <button type="button" class="btn btn-primary me-2"><i class="bx bxs-lock-open"></i> Đăng Nhập</button>
                            </router-link>
                            <router-link to="/dang-ky">
                                <button type="button" class="btn btn-secondary"><i class="fa-solid fa-right-to-bracket fa-2xs"></i> Đăng Ký</button>
                            </router-link>
                        </a>
                    </div>
                </template>

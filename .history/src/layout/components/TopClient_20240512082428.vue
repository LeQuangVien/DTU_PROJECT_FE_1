    ...
    <div class="user-box">
        <a class="d-flex align-items-center">
            ...
            <router-link to="/dang-ky">
                <button type="button" class="btn btn-secondary"><i class="fa-solid fa-right-to-bracket fa-2xs"></i> Đăng
                    Ký</button>
            </router-link>
        </a>
    </div>
...
<span style="font-size: 30px; margin-left: 20px; margin-right: 20px;">|</span>
<div class="p-2"> <i class="fa-solid fa-circle-info "></i><a href="" style="font-size: 15px; color: black;"
